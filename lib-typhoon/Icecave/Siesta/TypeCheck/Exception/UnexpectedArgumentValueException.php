...
{
    public function __construct($parameterName, $index, $value, $expectedType, \Exception $previous = null, \Icecave\Siesta\TypeCheck\TypeInspector $typeInspector = null)
    {
        if (null === $typeInspector) {
            $typeInspector = new \Icecave\Siesta\TypeCheck\TypeInspector();
        }
