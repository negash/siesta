...
abstract class TypeCheck
{
    ...
    {
        $validatorClassName = '\\Icecave\\Siesta\\TypeCheck\\Validator\\' . $className . 'TypeCheck';
    ...
    {
        return new \Eloquent\Typhoon\Configuration\RuntimeConfiguration(\Eloquent\Cosmos\ClassName::fromString('\\Icecave\\Siesta\\TypeCheck'), false);
    }
